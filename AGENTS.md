...
- `2025-12-19_clanker-design-doc.md` - Original design document
- `2025-12-21_exec-plan-v1.md` / `v2.md` - Implementation plans
- `2025-12-22_codex-clanker-repo-review.md` - Codex review
- `feedback-persistence-spec.md` - Feedback persistence specification
- `voice-actor-refactor-plan.md` - Voice actor refactor plan

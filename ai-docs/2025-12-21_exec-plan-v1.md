...
* [ ] …
* [x] 2025-12-19T20:20Z – Step 1: baseline test markers + conftest + sanity test, pytest -q
* [x] 2025-12-19T20:20Z – Step 2: core dataclasses + serialization tests
* [x] 2025-12-19T20:20Z – Step 3: ProviderFactory + env validation tests
* [x] 2025-12-19T20:20Z – Step 4: discord.py + dpytest spikes + notes
* [x] 2025-12-19T20:20Z – Step 5: OpenAI adapters + offline tests
* [x] 2025-12-19T20:20Z – Step 6: network smoke tests (skipped without secrets)
* [x] 2025-12-19T20:20Z – Step 7: respond() + replay log persistence
* [x] 2025-12-19T20:20Z – Step 8: voice ingest research + spike + docs
* [x] 2025-12-19T20:20Z – Step 9: voice pipeline implementation + tests
* [x] 2025-12-19T20:20Z – Step 10: discord host wiring + command tests
* [x] 2025-12-19T20:20Z – Step 11: manual smoke script
* [x] 2025-12-19T20:20Z – Step 12: /status health endpoint + tests
...
* 2025-12-19T20:20Z – Step 8 install: `apt-get install ffmpeg libopus0` failed once with 502 for ubuntu-mono; reran with --fix-missing and completed successfully.
...
* (append, don’t overwrite)
* 2025-12-19T20:20Z – Voice VAD implemented as energy-based thresholding to avoid heavy torch deps; documented Silero as upgrade path.
* 2025-12-19T20:20Z – OpenAI adapters use httpx-based REST calls for async control and testability.
* 2025-12-19T20:20Z – Discord host uses a ClankerClient subclass to attach `CommandTree` cleanly.
